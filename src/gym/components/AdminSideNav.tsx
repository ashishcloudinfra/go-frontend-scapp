...
const SideNavItems = {
  ...
  ManageMembers: {
    ...
    link: '/gym/admin/member/list',
  },
  MembershipPlans: {
    text: 'Membership plans',
    icon: <GrPlan size={20} className="mr-4" />,
    link: '/gym/admin/membership-plan/list',
  },
  ManageStaff: {
    text: 'Manage staff',
    icon: <FaPeopleRoof size={20} className="mr-4" />,
    link: '/gym/admin/staff/list',
  },
  EventScheduling: {
    text: 'Event scheduling',
    icon: <RiCalendarScheduleFill size={20} className="mr-4" />,
    link: '/gym/admin/event/list',
  },
  EventRoom: {
    text: 'Event Rooms',
    icon: <SiGoogleclassroom size={20} className="mr-4" />,
    link: '/gym/admin/event-room/list',
  },
  Inventory: {
    text: 'Inventory',
    icon: <MdInventory size={20} className="mr-4" />,
    link: '/gym/admin/inventory/list',
  },
}

const navItemUrlMap: Record<string, keyof typeof SideNavItems> = {
  '/gym/admin/dashboard': 'Dashboard',
  '/gym/admin/member/*': 'ManageMembers',
  '/gym/admin/membership-plan/*': 'MembershipPlans',
  '/gym/admin/staff/*': 'ManageStaff',
  '/gym/admin/event/*': 'EventScheduling',
  '/gym/admin/event-room/*': 'EventRoom',
  '/gym/admin/inventory/*': 'Inventory',
}
