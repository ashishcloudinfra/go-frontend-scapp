...
const SideNavItems = {
  Dashboard: {
    ...
    link: '/restaurant/admin/dashboard',
  },
  Orders: {
    text: 'Orders',
    icon: <FaClipboardList size={20} className="mr-4" />,
    link: '/restaurant/admin/orders/list',
  },
  ManageMenu: {
    text: 'Manage menu',
    icon: <MdOutlineRestaurantMenu size={20} className="mr-4" />,
    link: '/restaurant/admin/menu/list',
  }
}
...
const navItemUrlMap: Record<string, keyof typeof SideNavItems> = {
  ...
  '/restaurant/admin/menu/*': 'ManageMenu',
}
