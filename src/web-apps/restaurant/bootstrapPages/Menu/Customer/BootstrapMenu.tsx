...
import { IMenuProps } from "../../../pages/Customer/Menu";
...
export default function BootstrapMenuItem({ WrappedComponent }: { WrappedComponent: React.FunctionComponent<IMenuProps> }) {
