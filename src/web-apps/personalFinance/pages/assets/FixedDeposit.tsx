...
export interface IFixedDepositProps {
  assetTypes: string[];
  assetItems: AssetItem[];
  fetchAssetItems: () => void;
}

export default function FixedDeposit(props: IFixedDepositProps) {
  ...
  const assetItems = useMemo(() => {
    return props.assetItems.filter(v => v.AssetType === 'FixedDeposit');
  }, [props.assetItems])
        ...
        >
          <div className="flex justify-between">
            ...
            <div className="flex gap-4 flex-wrap">
              <span className="text-gray-700">Rs. {formatToIndianCurrency(v.CurrentValue || 0)}</span>
        ...
        children={<FormComponent
          schema={[
            ...
            },
            {
              ...
              name: 'currentValue',
              type: 'number',
              initValue: selectedItem?.CurrentValue || '',
              required: true
            }
          ]}
