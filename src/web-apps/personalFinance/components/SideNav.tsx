...
const SideNavItems = {
  Dashboard: {
    ...
    link: '/personalfinance/dashboard',
  },
  Budget: {
    text: 'Budget',
    icon: <GiTakeMyMoney size={20} className="mr-4" />,
    link: '/personalfinance/budget/manage',
  },
  Asset: {
    text: 'Asset',
    icon: <GrGrow size={20} className="mr-4" />,
    link: '/personalfinance/asset/manage',
  },
  Calculators: {
    text: 'Calculators',
    icon: <FaCalculator size={20} className="mr-4" />,
    link: '/personalfinance/calculators/home',
  },
  Pricing: {
    text: 'Pricing',
    icon: <IoIosPricetags size={20} className="mr-4" />,
    link: '/personalfinance/pricing/plans',
  },
}

const navItemUrlMap: Record<string, keyof typeof SideNavItems> = {
  '/personalfinance/dashboard': 'Dashboard',
  '/personalfinance/budget/*': 'Budget',
  '/personalfinance/calculators/*': 'Calculators',
  '/personalfinance/asset/*': 'Asset',
  '/personalfinance/pricing/*': 'Pricing',
}
      ...
      >
        ...
        <nav className="mt-6 min-h-screen flex flex-col justify-between mx-3">
          <ul className="space-y-2">
            ...
            >
              <Link
                ...
                viewTransition
                className={`text-sm px-4 py-3 mb-3 rounded-sm flex hover:scale-105 transform transition duration-200 hover:text-blue-200 ${selectedNavItem === navItemKey ? 'bg-secondary rounded-xl text-quaternary hover:text-tertiary font-semibold scale-105' : ''}`}
              >
          ...
          <ul className="mb-36">
            <li>
              <a
                href={'https://merchant.razorpay.com/policy/PraXYZfh8ABOhW/terms'}
                target="_blank"
              ...
              >
                <MdPolicy size={20} className="mr-4" />
                Our policy
              </a>
            </li>
            <li>
